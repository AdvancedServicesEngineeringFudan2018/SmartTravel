...
function setTraffic(wagon) {
    ...
    if (rand <= 50) {
        ...
        wagon.timeout += wagon.path.steps[idx].duration * 0.5;
        wagon.path.steps[idx].duration *= 1.5;
        wagon.stepSimplifierIns.getRenderOptions().pathLineStyle.strokeStyle = 'yellow';
